...
class SessionManager {
    ...
    async init() {
        ...
        console.log('🔍 Session-Manager Init: Cookie gefunden?', this.sessionId ? 'Ja: ' + this.sessionId : 'Nein');
    ...
    async saveServices(offers, demands) {
        ...
        try {
            const response = await fetch(`${API_URL}/session/${this.sessionId}/services`, {
                method: 'PUT',
                credentials: 'include',
                headers: {
                    'Content-Type': 'application/json'
    ...
    async attachUser(username) {
        ...
        try {
            const response = await fetch(`${API_URL}/session/${this.sessionId}/attach-user`, {
                method: 'POST',
                credentials: 'include',
                headers: {
                    'Content-Type': 'application/json'
    ...
    async convertToMarkets() {
        ...
        try {
            const response = await fetch(`${API_URL}/session/${this.sessionId}/convert-to-markets`, {
                method: 'POST',
                credentials: 'include',
                headers: {
                    'Content-Type': 'application/json'
            ...
            if (response.ok) {
                console.log('✓ Session zu Markets konvertiert');
